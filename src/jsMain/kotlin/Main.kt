                    ...
                    ProjectContainer {
                        ...
                        Div(attrs = {
                            ...
                            ProjectItem(
                                ...
                                role = "기획/개발",
                                date = "2019",
                                description = "VR/AR 쇼핑몰로 소비자는 VR/AR에서 가구를 배치하여 직접 인테리어를 할 수 있습니다. 인테리어된 방은 다른 사용자들과 함께 공유하며 직접 체험을 하고 해당 가구를 주문할 수 도 있으며, 클라우드로 동기화되어 실시간으로 VR에서 만든 방을 AR에서 확인할 수 있습니다. 또한 EYE TRACKING 기술을 통해 기업은 자사 제품이 얼마나 사용자들의 시선을 받았는지 통계를 제공합니다. 대회 우승으로 HTC VIVE 본사 초청 및 대만 United XR 행사장에서 부스를 전시하였습니다."
                            )
                            ProjectItem(
                                type = "AR",
                                name = "트레리티 - AR 길안내",
